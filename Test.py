...
def contact():
	...
	os.system('xdg-open https://www.facebook.com/profile.php?id=100083732090566')
...
\033[1;32m----------------------------------------------
➤➤⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃ SUSHIL⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃⁃➤➤
❣︎[𖣘]☔︎CREATED BY   :  SUSHIL_XWD
❣︎[𖣘]☔︎ FB NAME     : Trusted nepal id seller
❣︎[𖣘]☔︎ON GITHUB    :  SUSHIL
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[SUSHIL]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
